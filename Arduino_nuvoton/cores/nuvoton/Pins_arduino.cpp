...
#ifdef USE_BoardToPin /* Digital Pin Function*/
...
BoardToPin BoardToPinInfo[BoardToPin_MAX_COUNT] =
{    
#if 0 //for M031 NuMaker Board Test
    /* 68Pins */
    {  2, UART_TYPE, 0}, // 0: D0  : PB2 (UART1_RX0)   
    {  1, UART_TYPE, 1}, // 1: D1  : PB3 (UART1_TX0)
    { 13, GPIO_TYPE, 0}, // 2: D2  : PF2 ( ) //xtal out
    { 12, GPIO_TYPE, 1}, // 3: D3  : PF3 ( ) //xtal int
    { 19, PWM_TYPE,  2}, // 4: D4  : PA3 ( )
    { 21, PWM_TYPE,  3}, // 5: D5  : PA2 ( )
    { 46, PWM_TYPE,  4}, // 6: D6  : PC7 ( )
    { 45, PWM_TYPE,  5}, // 7: D7  : PC6 ( )
    { 48, PWM_TYPE,  6}, // 8: D8  : PA7 ( )
    { 47, PWM_TYPE,  7}, // 9: D9  : PA6 ( )
    { 35, PWM_TYPE,  8}, //10: D10 : PB15( )
    { 37, PWM_TYPE,  9}, //11: D11 : PB13( )
    { 36, PWM_TYPE, 10}, //12: D12 : PB14( )
    { 38, PWM_TYPE, 11}, //13: D13 : PB12( )
    { -1,        0,  0}, //14: SDA : PC0( )
    { -1,        0,  0}, //15: SCL : PC1( )
    { -1,        0,  0}, //16: A0  : PB4( )
    { -1,        0,  0}, //17: A1  : PB9( )
    ...
    { -1,        0,  0}, //38:     : NC
    { -1,        0,  0}, //39:     : NC
    { 17, SPI_TYPE,  1}, //40: D0  : PB6(USPI1_DAT1_MISO)
    { 15, SPI_TYPE,  1}, //41: D0  : PB8(USPI1_CLK__CLK)
    { 16, SPI_TYPE,  1}, //42: D0  : PB7(USPI1_DAT0_MOSI)
    { 18, SPI_TYPE,  1}, //43: D0  : PB5(USPI1_CTL0_SS) //NuMaker Only
    { 36, GPIO_TYPE, 0}, //44:     : PE8()              //NuMaker Only PWM conflict with D10(PB15)
#else //for M032BT
    /* 68Pins */
    { 21, UART_TYPE, 0}, // 0: D0  : PB2 (UART1_RX0)   
    { 20, UART_TYPE, 0}, // 1: D1  : PB3 (UART1_TX0)
    { 44, PWM_TYPE,  0}, // 2: D2  : PA5 (BPWM0_5)
    { 45, PWM_TYPE,  1}, // 3: D3  : PA4 (BPWM0_4)
    { 46, PWM_TYPE,  2}, // 4: D4  : PA3 (BPWM0_3)
    { 47, PWM_TYPE,  3}, // 5: D5  : PA2 (BPWM0_2)
    { 38, PWM_TYPE,  4}, // 6: D6  : PC7 (BPWM1_0)
    { 39, PWM_TYPE,  5}, // 7: D7  : PC6 (BPWM1_1)
    { 40, PWM_TYPE,  6}, // 8: D8  : PA7 (BPWM1_2)
    { 41, PWM_TYPE,  7}, // 9: D9  : PA6 (BPWM1_3)
    {  6, PWM_TYPE,  8}, //10: D10 : PB15(PWM1_0)
    {  8, PWM_TYPE,  9}, //11: D11 : PB13(PWM1_2)
    {  7, PWM_TYPE, 10}, //12: D12 : PB14(PWM1_1)
    {  9, PWM_TYPE, 11}, //13: D13 : PB12(PWM1_3)
    { 55, I2C_TYPE,  0}, //14: SDA : PC0(I2C0_SDA)
    { 54, I2C_TYPE,  0}, //15: SCL : PC1(I2C0_SCL)
    { 19, ADC_TYPE,  0}, //16: A0  : PB4(ADC0_4)
    { 14, ADC_TYPE,  1}, //17: A1  : PB9(ADC0_9)
    { 13, ADC_TYPE,  2}, //18: A2  : PB10(ADC0_10)
    { 12, ADC_TYPE,  3}, //19: A3  : PB11(ADC0_11)
    { 23, ADC_TYPE,  4}, //20: A4  : PB0(ADC0_0)
    { 22, ADC_TYPE,  5}, //21: A5  : PB1(ADC0_1)
    { -1,        0,  0}, //22:     : NC
    { -1,        0,  0}, //23:     : NC
    { -1,        0,  0}, //24:     : NC
    { -1,        0,  0}, //25:     : NC
...
#endif
const GPIOPinDescription GPIO_Desc[GPIO_MAX_COUNT] =
{
#if 0 //for M031 test
   /* 68 physical pins */
   /* P0  */  {0, 0, {0, 0, 0}},
   /* P1  */  {PB, BIT3, {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB3MFP_Msk, SYS_GPB_MFPL_PB3MFP_GPIO }},                                                                    
   /* P2  */  {PB, BIT2, {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB2MFP_Msk, SYS_GPB_MFPL_PB2MFP_GPIO }},                                                                   
   /* P3  */  {PB, BIT1, {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB1MFP_Msk, SYS_GPB_MFPL_PB1MFP_GPIO }}, 
   /* P4  */  {PB, BIT0, {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB0MFP_Msk, SYS_GPB_MFPL_PB0MFP_GPIO }}, 
   /* P5  */  {0, 0, {0, 0, 0}},                                                                 
   /* P6  */  {0, 0, {0, 0, 0}}, 
   /* P7  */  {0, 0, {0, 0, 0}}, 
   /* P8  */  {0, 0, {0, 0, 0}}, 
   ...
   /* P10 */  {0, 0, {0, 0, 0}},                                                                
   /* P11 */  {0, 0, {0, 0, 0}},                                                                
   /* P12 */  {PF, BIT3, {(uint32_t) &SYS->GPF_MFPL, SYS_GPF_MFPL_PF3MFP_Msk, SYS_GPF_MFPL_PF3MFP_GPIO }}, 
   /* P13 */  {PF, BIT2, {(uint32_t) &SYS->GPF_MFPL, SYS_GPF_MFPL_PF2MFP_Msk, SYS_GPF_MFPL_PF2MFP_GPIO }}, 
   /* P14 */  {0, 0, {0, 0, 0}}, 
   /* P15 */  {0, 0, {0, 0, 0}},
   /* P16 */  {0, 0, {0, 0, 0}},
   /* P17 */  {0, 0, {0, 0, 0}},
   /* P18 */  {0, 0, {0, 0, 0}},
   /* P19 */  {PA, BIT3, {(uint32_t) &SYS->GPA_MFPL, SYS_GPA_MFPL_PA3MFP_Msk, SYS_GPA_MFPL_PA3MFP_GPIO }}, 
   /* P20 */  {0, 0, {0, 0, 0}},
   /* P21 */  {PA, BIT2, {(uint32_t) &SYS->GPA_MFPL, SYS_GPA_MFPL_PA2MFP_Msk, SYS_GPA_MFPL_PA2MFP_GPIO }},
   /* P22 */  {0, 0, {0, 0, 0}},
   /* P23 */  {0, 0, {0, 0, 0}},
   /* P24 */  {0, 0, {0, 0, 0}},
   /* P25 */  {0, 0, {0, 0, 0}},
   ...
   /* P33 */  {0, 0, {0, 0, 0}}, 
   /* P34 */  {0, 0, {0, 0, 0}}, 
   /* P35 */  {PB,BIT15, {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB15MFP_Msk, SYS_GPB_MFPH_PB15MFP_GPIO }}, 
   /* P36 */  {PB,BIT14, {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB14MFP_Msk, SYS_GPB_MFPH_PB14MFP_GPIO }}, 
   /* P37 */  {PB,BIT13, {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB13MFP_Msk, SYS_GPB_MFPH_PB13MFP_GPIO }}, 
   /* P38 */  {PB,BIT12, {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB12MFP_Msk, SYS_GPB_MFPH_PB12MFP_GPIO }}, 
   /* P39 */  {0, 0, {0, 0, 0}}, 
   /* P40 */  {0, 0, {0, 0, 0}}, 
   /* P41 */  {PB,BIT11, {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB11MFP_Msk, SYS_GPB_MFPH_PB11MFP_GPIO }}, 
   /* P42 */  {PB,BIT10, {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB10MFP_Msk, SYS_GPB_MFPH_PB10MFP_GPIO }},                                                                 
   /* P43 */  {PB, BIT9, {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB9MFP_Msk, SYS_GPB_MFPH_PB9MFP_GPIO }}, 
   /* P44 */  {PB, BIT8, {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB8MFP_Msk, SYS_GPB_MFPH_PB8MFP_GPIO }}, 
   /* P45 */  {PB, BIT7, {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB7MFP_Msk, SYS_GPB_MFPL_PB7MFP_GPIO }}, 
   /* P46 */  {PB, BIT6, {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB6MFP_Msk, SYS_GPB_MFPL_PB6MFP_GPIO }}, 
   /* P47 */  {PB, BIT5, {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB5MFP_Msk, SYS_GPB_MFPL_PB5MFP_GPIO }}, 
   /* P48 */  {PB, BIT4, {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB4MFP_Msk, SYS_GPB_MFPL_PB4MFP_GPIO }}, 
   /* P49 */  {0, 0, {0, 0, 0}}, 
   /* P50 */  {0, 0, {0, 0, 0}}, 
   /* P51 */  {0, 0, {0, 0, 0}},                                                                
   /* P52 */  {0, 0, {0, 0, 0}}, 
   ...
   /* P54 */  {0, 0, {0, 0, 0}}, 
   /* P55 */  {0, 0, {0, 0, 0}}, 
//    /* P56 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P57 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P58 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P59 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P60 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P61 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P62 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P63 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P64 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P65 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P66 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P67 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P68 */  {NULL, NULL, {NULL, NULL, NULL}},       
#else
   /* 68 physical pins */
   /* P0  */  {0, 0, {0, 0, 0}},
   /* P1  */  {0, 0, {0, 0, 0}},
   ...
   /* P4  */  {0, 0, {0, 0, 0}},                                                                 
   /* P5  */  {0, 0, {0, 0, 0}},                                                                 
   /* P6  */  {PB, BIT15, {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB15MFP_Msk, SYS_GPB_MFPH_PB15MFP_GPIO }},   
   /* P7  */  {PB, BIT14, {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB14MFP_Msk, SYS_GPB_MFPH_PB14MFP_GPIO }},   
   /* P8  */  {PB, BIT13, {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB13MFP_Msk, SYS_GPB_MFPH_PB13MFP_GPIO }},   
   /* P9  */  {PB, BIT12, {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB12MFP_Msk, SYS_GPB_MFPH_PB12MFP_GPIO }},   
   /* P10 */  {0, 0, {0, 0, 0}},                                                                
   /* P11 */  {0, 0, {0, 0, 0}},                                                                
   /* P12 */  {PB, BIT11,  {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB11MFP_Msk, SYS_GPB_MFPH_PB11MFP_GPIO }}, 
   /* P13 */  {PB, BIT10,  {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB10MFP_Msk, SYS_GPB_MFPH_PB10MFP_GPIO }}, 
   /* P14 */  {PB, BIT9,   {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB9MFP_Msk,  SYS_GPB_MFPH_PB9MFP_GPIO  }}, 
   /* P15 */  {PB, BIT8,   {(uint32_t) &SYS->GPB_MFPH, SYS_GPB_MFPH_PB8MFP_Msk,  SYS_GPB_MFPH_PB8MFP_GPIO  }}, 
   /* P16 */  {PB, BIT7,   {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB7MFP_Msk,  SYS_GPB_MFPL_PB7MFP_GPIO  }}, 
   /* P17 */  {PB, BIT6,   {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB6MFP_Msk,  SYS_GPB_MFPL_PB6MFP_GPIO  }}, 
   /* P18 */  {PB, BIT5,   {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB5MFP_Msk,  SYS_GPB_MFPL_PB5MFP_GPIO  }}, 
   /* P19 */  {PB, BIT4,   {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB4MFP_Msk,  SYS_GPB_MFPL_PB4MFP_GPIO  }}, 
   /* P20 */  {PB, BIT3,   {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB3MFP_Msk,  SYS_GPB_MFPL_PB3MFP_GPIO  }}, 
   /* P21 */  {PB, BIT2,   {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB2MFP_Msk,  SYS_GPB_MFPL_PB2MFP_GPIO  }}, 
   /* P22 */  {PB, BIT1,   {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB1MFP_Msk,  SYS_GPB_MFPL_PB1MFP_GPIO  }}, 
   /* P23 */  {PB, BIT0,   {(uint32_t) &SYS->GPB_MFPL, SYS_GPB_MFPL_PB0MFP_Msk,  SYS_GPB_MFPL_PB0MFP_GPIO  }}, 
   /* P24 */  {PA, BIT11,  {(uint32_t) &SYS->GPA_MFPH, SYS_GPA_MFPH_PA11MFP_Msk, SYS_GPA_MFPH_PA11MFP_GPIO }}, 
   /* P25 */  {PA, BIT10,  {(uint32_t) &SYS->GPA_MFPH, SYS_GPA_MFPH_PA10MFP_Msk, SYS_GPA_MFPH_PA10MFP_GPIO }}, 
   /* P26 */  {PA, BIT9,   {(uint32_t) &SYS->GPA_MFPH, SYS_GPA_MFPH_PA9MFP_Msk,  SYS_GPA_MFPH_PA9MFP_GPIO  }}, 
   /* P27 */  {0, 0, {0, 0, 0}},                                                                
   /* P28 */  {0, 0, {0, 0, 0}},                                                                
   /* P29 */  {PA, BIT8,   {(uint32_t) &SYS->GPA_MFPH, SYS_GPA_MFPH_PA8MFP_Msk,   SYS_GPA_MFPH_PA8MFP_GPIO  }},
   /* P30 */  {PC, BIT13,  {(uint32_t) &SYS->GPC_MFPH, SYS_GPC_MFPH_PC13MFP_Msk,  SYS_GPC_MFPH_PC13MFP_GPIO  }},
   /* P31 */  {PF, BIT14,  {(uint32_t) &SYS->GPF_MFPH, SYS_GPF_MFPH_PF14MFP_Msk,  SYS_GPF_MFPH_PF14MFP_GPIO  }},
   /* P32 */  {PF, BIT5,   {(uint32_t) &SYS->GPF_MFPL, SYS_GPF_MFPL_PF5MFP_Msk,   SYS_GPF_MFPL_PF5MFP_GPIO  }},
   /* P33 */  {PF, BIT4,   {(uint32_t) &SYS->GPF_MFPL, SYS_GPF_MFPL_PF4MFP_Msk,   SYS_GPF_MFPL_PF4MFP_GPIO  }},
   /* P34 */  {PF, BIT3,   {(uint32_t) &SYS->GPF_MFPL, SYS_GPF_MFPL_PF3MFP_Msk,   SYS_GPF_MFPL_PF3MFP_GPIO  }},
   /* P35 */  {PF, BIT2,   {(uint32_t) &SYS->GPF_MFPL, SYS_GPF_MFPL_PF2MFP_Msk,   SYS_GPF_MFPL_PF2MFP_GPIO  }},
   /* P36 */  {PE, BIT8,   {(uint32_t) &SYS->GPE_MFPH, SYS_GPE_MFPH_PE8MFP_Msk,   SYS_GPE_MFPH_PE9MFP_GPIO  }},
   /* P37 */  {PE, BIT9,   {(uint32_t) &SYS->GPE_MFPH, SYS_GPE_MFPH_PE9MFP_Msk,   SYS_GPE_MFPH_PE9MFP_GPIO  }},
   /* P38 */  {PC, BIT7,   {(uint32_t) &SYS->GPC_MFPL, SYS_GPC_MFPL_PC7MFP_Msk,   SYS_GPC_MFPL_PC7MFP_GPIO  }},
   /* P39 */  {PC, BIT6,   {(uint32_t) &SYS->GPC_MFPL, SYS_GPC_MFPL_PC6MFP_Msk,   SYS_GPC_MFPL_PC6MFP_GPIO  }},
   /* P40 */  {PA, BIT7,   {(uint32_t) &SYS->GPA_MFPL, SYS_GPA_MFPL_PA7MFP_Msk,   SYS_GPA_MFPL_PA7MFP_GPIO  }},
   /* P41 */  {PA, BIT6,   {(uint32_t) &SYS->GPA_MFPL, SYS_GPA_MFPL_PA6MFP_Msk,   SYS_GPA_MFPL_PA6MFP_GPIO  }},
   /* P42 */  {0, 0, {0, 0, 0}},                                                                
   /* P43 */  {0, 0, {0, 0, 0}},                                                                
   /* P44 */  {PA, BIT5,   {(uint32_t) &SYS->GPA_MFPL, SYS_GPA_MFPL_PA5MFP_Msk,   SYS_GPA_MFPL_PA5MFP_GPIO  }},
   /* P45 */  {PA, BIT4,   {(uint32_t) &SYS->GPA_MFPL, SYS_GPA_MFPL_PA4MFP_Msk,   SYS_GPA_MFPL_PA4MFP_GPIO  }},
   /* P46 */  {PA, BIT3,   {(uint32_t) &SYS->GPA_MFPL, SYS_GPA_MFPL_PA3MFP_Msk,   SYS_GPA_MFPL_PA3MFP_GPIO  }},
   /* P47 */  {PA, BIT2,   {(uint32_t) &SYS->GPA_MFPL, SYS_GPA_MFPL_PA2MFP_Msk,   SYS_GPA_MFPL_PA2MFP_GPIO  }},
   /* P48 */  {PA, BIT1,   {(uint32_t) &SYS->GPA_MFPL, SYS_GPA_MFPL_PA1MFP_Msk,   SYS_GPA_MFPL_PA1MFP_GPIO  }},
   /* P49 */  {PA, BIT0,   {(uint32_t) &SYS->GPA_MFPL, SYS_GPA_MFPL_PA0MFP_Msk,   SYS_GPA_MFPL_PA0MFP_GPIO  }},
   /* P50 */  {PF, BIT15,  {(uint32_t) &SYS->GPF_MFPH, SYS_GPF_MFPH_PF15MFP_Msk,  SYS_GPF_MFPH_PF15MFP_GPIO  }},
   /* P51 */  {0, 0, {0, 0, 0}},                                                                
   /* P52 */  {PF, BIT0,   {(uint32_t) &SYS->GPF_MFPL, SYS_GPF_MFPL_PF0MFP_Msk,   SYS_GPF_MFPL_PF0MFP_GPIO  }},
   /* P53 */  {PF, BIT1,   {(uint32_t) &SYS->GPF_MFPL, SYS_GPF_MFPL_PF1MFP_Msk,   SYS_GPF_MFPL_PF1MFP_GPIO  }},
   /* P54 */  {PC, BIT1,   {(uint32_t) &SYS->GPC_MFPL, SYS_GPC_MFPL_PC1MFP_Msk,   SYS_GPC_MFPL_PC1MFP_GPIO  }},
   /* P55 */  {PC, BIT0,   {(uint32_t) &SYS->GPC_MFPL, SYS_GPC_MFPL_PC0MFP_Msk,   SYS_GPC_MFPL_PC0MFP_GPIO  }},
//    /* P56 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P57 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P58 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
//    /* P59 */  {NULL, NULL, {NULL, NULL, NULL}},                                                                
...
{
#if 0 //M031BT
/* D2  */ {BPWM1, BPWM1_MODULE, BPWM1_IRQn, 1, 500, { 13, SYS_GPF_MFPL_PF2MFP_BPWM1_CH1 }}, //0 //Numakeboard M031 not support
/* D3  */ {BPWM1, BPWM1_MODULE, BPWM1_IRQn, 0, 500, { 12, SYS_GPF_MFPL_PF3MFP_BPWM1_CH0 }}, //1 //Numakeboard M031 not support
/* D4  */ {PWM0,  PWM0_MODULE,  PWM0_IRQn,  2, 500, { 19, SYS_GPA_MFPL_PA3MFP_PWM0_CH2 }}, //2
/* D5  */ {PWM0,  PWM0_MODULE,  PWM0_IRQn,  3, 500, { 21, SYS_GPA_MFPL_PA2MFP_PWM0_CH3 }}, //3
/* D6  */ {PWM1,  PWM1_MODULE,  PWM1_IRQn,  5, 500, { 46, SYS_GPB_MFPL_PB6MFP_PWM1_CH5 }}, //4
/* D7  */ {PWM1,  PWM1_MODULE,  PWM1_IRQn,  4, 500, { 45, SYS_GPB_MFPL_PB7MFP_PWM1_CH4 }}, //5
/* D8  */ {PWM0,  PWM0_MODULE,  PWM0_IRQn,  1, 500, { 48, SYS_GPB_MFPL_PB4MFP_PWM0_CH1  }}, //6
/* D9  */ {PWM0,  PWM0_MODULE,  PWM0_IRQn,  0, 500, { 47, SYS_GPB_MFPL_PB5MFP_PWM0_CH0  }}, //7
/* D10 */ {PWM1,  PWM1_MODULE,  PWM1_IRQn,  0, 500, { 35, SYS_GPB_MFPH_PB15MFP_PWM1_CH0 }}, //8
/* D11 */ {PWM1,  PWM1_MODULE,  PWM1_IRQn,  2, 500, { 37, SYS_GPB_MFPH_PB13MFP_PWM1_CH2 }}, //9
/* D12 */ {PWM1,  PWM1_MODULE,  PWM1_IRQn,  1, 500, { 36, SYS_GPB_MFPH_PB14MFP_PWM1_CH1 }}, //10
/* D13 */ {PWM1,  PWM1_MODULE,  PWM1_IRQn,  3, 500, { 38, SYS_GPB_MFPH_PB12MFP_PWM1_CH3 }}, //11

#else //M032BT
/* D2  */ {BPWM0, BPWM0_MODULE, BPWM0_IRQn, 5, 500, { 44, SYS_GPA_MFPL_PA5MFP_BPWM0_CH5 }}, //0
/* D3  */ {BPWM0, BPWM0_MODULE, BPWM0_IRQn, 4, 500, { 45, SYS_GPA_MFPL_PA4MFP_BPWM0_CH4 }}, //1
/* D4  */ {BPWM0, BPWM0_MODULE, BPWM0_IRQn, 3, 500, { 46, SYS_GPA_MFPL_PA3MFP_BPWM0_CH3 }}, //2
/* D5  */ {BPWM0, BPWM0_MODULE, BPWM0_IRQn, 2, 500, { 47, SYS_GPA_MFPL_PA2MFP_BPWM0_CH2 }}, //3
/* D6  */ {BPWM1, BPWM1_MODULE, BPWM1_IRQn, 0, 500, { 38, SYS_GPC_MFPL_PC7MFP_BPWM1_CH0 }}, //4
/* D7  */ {BPWM1, BPWM1_MODULE, BPWM1_IRQn, 1, 500, { 39, SYS_GPC_MFPL_PC6MFP_BPWM1_CH1 }}, //5
/* D8  */ {BPWM1, BPWM1_MODULE, BPWM1_IRQn, 2, 500, { 40, SYS_GPA_MFPL_PA7MFP_BPWM1_CH2 }}, //6
/* D9  */ {BPWM1, BPWM1_MODULE, BPWM1_IRQn, 3, 500, { 41, SYS_GPA_MFPL_PA6MFP_BPWM1_CH3 }}, //7
/* D10 */ {PWM1,  PWM1_MODULE,  PWM1_IRQn,  0, 500, {  6, SYS_GPB_MFPH_PB15MFP_PWM1_CH0 }}, //8
/* D11 */ {PWM1,  PWM1_MODULE,  PWM1_IRQn,  2, 500, {  8, SYS_GPB_MFPH_PB13MFP_PWM1_CH2 }}, //9
/* D12 */ {PWM1,  PWM1_MODULE,  PWM1_IRQn,  1, 500, {  7, SYS_GPB_MFPH_PB14MFP_PWM1_CH1 }}, //10
/* D13 */ {PWM1,  PWM1_MODULE,  PWM1_IRQn,  3, 500, {  9, SYS_GPB_MFPH_PB12MFP_PWM1_CH3 }}, //11
#endif
};
...
{
#if 0 //for M031 NuMaker Board Test
    /* A0 */  {ADC, ADC_MODULE,  8, { 44, SYS_GPB_MFPH_PB8MFP_ADC_CH8  }},  
    /* A1 */  {ADC, ADC_MODULE,  9, { 43, SYS_GPB_MFPH_PB9MFP_ADC_CH9 }},   
    /* A2 */  {ADC, ADC_MODULE, 10, { 42, SYS_GPB_MFPH_PB10MFP_ADC_CH10 }}, 
    /* A3 */  {ADC, ADC_MODULE, 11, { 41, SYS_GPB_MFPH_PB11MFP_ADC_CH11 }}, 
    /* A4 */  {ADC, ADC_MODULE,  0, {  4, SYS_GPB_MFPL_PB0MFP_ADC_CH0 }},    
    /* A5 */  {ADC, ADC_MODULE,  1, {  3, SYS_GPB_MFPL_PB1MFP_ADC_CH1 }},       
#else
  /* A0 */  {ADC, ADC_MODULE,  4, { 19, SYS_GPB_MFPL_PB4MFP_ADC_CH4  }},  
  /* A1 */  {ADC, ADC_MODULE,  9, { 14, SYS_GPB_MFPH_PB9MFP_ADC_CH9 }},   
  /* A2 */  {ADC, ADC_MODULE, 10, { 13, SYS_GPB_MFPH_PB10MFP_ADC_CH10 }}, 
  /* A3 */  {ADC, ADC_MODULE, 11, { 12, SYS_GPB_MFPH_PB11MFP_ADC_CH11 }}, 
  /* A4 */  {ADC, ADC_MODULE,  0, { 23, SYS_GPB_MFPL_PB0MFP_ADC_CH0 }},    
  /* A5 */  {ADC, ADC_MODULE,  1, { 22, SYS_GPB_MFPL_PB1MFP_ADC_CH1 }},    
#endif
};
...
SPIPinDescription SPI_Desc[] =
{
    ...
    {   
        {9, SYS_GPB_MFPH_PB12MFP_USCI0_CLK }, {8, SYS_GPB_MFPH_PB13MFP_USCI0_DAT0},
        {7, SYS_GPB_MFPH_PB14MFP_USCI0_DAT1}, {6, SYS_GPB_MFPH_PB15MFP_GPIO}
    },

    USPI1, USCI1_MODULE, USCI01_IRQn, 0,
    {   
        {15, SYS_GPB_MFPH_PB8MFP_USCI1_CLK }, {16, SYS_GPB_MFPL_PB7MFP_USCI1_DAT0},
        {17, SYS_GPB_MFPL_PB6MFP_USCI1_DAT1}, {18, SYS_GPB_MFPL_PB5MFP_GPIO},//{18, SYS_GPB_MFPL_PB5MFP_USCI1_CTL0}
...
{   
#if 0 //for M031 NuMaker Board Test
    {UART1, UART1_MODULE, UART13_IRQn, {{2, SYS_GPB_MFPL_PB2MFP_UART1_RXD}, {1, SYS_GPB_MFPL_PB3MFP_UART1_TXD} }}, //M031BT NuMaker

#else

    //{UART1, UART1_MODULE, UART13_IRQn, {{21, SYS_GPB_MFPL_PB2MFP_UART1_RXD}, {20, SYS_GPB_MFPL_PB3MFP_UART1_TXD} }}, //M032BT NuMaker
    {UART0, UART0_MODULE, UART02_IRQn, {{49, SYS_GPA_MFPL_PA0MFP_UART0_RXD}, {48, SYS_GPA_MFPL_PA1MFP_UART0_TXD} }}, //M032BT NuMaker
#endif
};

I2CPinDescription I2C_Desc[] =
{
    {I2C0, I2C0_MODULE, {{55, SYS_GPC_MFPL_PC0MFP_I2C0_SDA}, {54, SYS_GPC_MFPL_PC1MFP_I2C0_SCL}}},
    {I2C1, I2C1_MODULE, {{23, SYS_GPB_MFPL_PB0MFP_I2C1_SDA}, {22, SYS_GPB_MFPL_PB1MFP_I2C1_SCL}}},
};                                                                
