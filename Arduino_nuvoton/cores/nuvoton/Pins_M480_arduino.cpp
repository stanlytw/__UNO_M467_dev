...
BoardToPin BoardToPinInfo[] =
{
    ...
    {100, PWM_TYPE, 4}, // 6: PE4(PWM0_CH3)     (D6/PWM4)
    { 99, PWM_TYPE, 5}, // 7: PE5(PWM0_CH2)     (D7/PWM5)
...
GPIOPinDescription GPIO_Desc[] =
{
    ...
    {PC, BIT9, {(uint32_t) &SYS->GPC_MFPH, SYS_GPC_MFPH_PC9MFP_Msk, SYS_GPC_MFPH_PC9MFP_GPIO }}, //67
    ...
    {PG, BIT2, {(uint32_t) &SYS->GPG_MFPL, SYS_GPG_MFPL_PG2MFP_Msk, SYS_GPG_MFPL_PG2MFP_GPIO }}, //107
	{PG, BIT1, {(uint32_t) &SYS->GPG_MFPL, SYS_GPG_MFPL_PG1MFP_Msk, SYS_GPG_MFPL_PG1MFP_GPIO }}, //108
    {NULL, 0, {0, 0, 0}}, //109
    {NULL, 0, {0, 0, 0}}, //110
    {NULL, 0, {0, 0, 0}}, //111
    {NULL, 0, {0, 0, 0}}, //112
...
{
    {EPWM1, (uint32_t)EPWM1_MODULE, EPWM1P0_IRQn, 3, 500, {67, SYS_GPC_MFPH_PC9MFP_EPWM1_CH3  }}, //0  PC9, D2, EPWM1_CH3
    {EPWM1, (uint32_t)EPWM1_MODULE, EPWM1P0_IRQn, 2, 500, { 7, SYS_GPC_MFPH_PC10MFP_EPWM1_CH2 }}, //1  PC10, D3, EPWM1_CH2
    {EPWM1, (uint32_t)EPWM1_MODULE, EPWM1P0_IRQn, 1, 500, { 6, SYS_GPC_MFPH_PC11MFP_EPWM1_CH1 }}, //2  PC11, D4, EPWM1_CH1
    {EPWM1, (uint32_t)EPWM1_MODULE, EPWM1P0_IRQn, 0, 500, { 5, SYS_GPC_MFPH_PC12MFP_EPWM1_CH0 }}, //3  PC12, D5, EPWM1_CH0
    {EPWM0, (uint32_t)EPWM0_MODULE, EPWM0P0_IRQn, 3, 500, {100, SYS_GPE_MFPL_PE4MFP_EPWM0_CH3  }}, //4  PE4, D6, EPWM0_CH3
    {EPWM0, (uint32_t)EPWM0_MODULE, EPWM0P0_IRQn, 2, 500, {99, SYS_GPE_MFPL_PE5MFP_EPWM0_CH2  }}, //5  PE5, D7, EPWM0_CH2
    {EPWM0, (uint32_t)EPWM0_MODULE, EPWM0P0_IRQn, 0, 500, {55, SYS_GPA_MFPL_PA5MFP_EPWM0_CH0  }}, //6  PA5, D8, EPWM0_CH0
    {EPWM0, (uint32_t)EPWM0_MODULE, EPWM0P0_IRQn, 1, 500, {56, SYS_GPA_MFPL_PA4MFP_EPWM0_CH1  }}  //7  PA4, D9, EPWM0_CH1
};

ADCPinDescription ADC_Desc[] =
{
    
    {EADC, EADC_MODULE, 6, { 128, SYS_GPB_MFPL_PB6MFP_EADC0_CH6 }}, //A0 PB6
    {EADC, EADC_MODULE, 7, { 127, SYS_GPB_MFPL_PB7MFP_EADC0_CH7 }}, //A1 PB7
    {EADC, EADC_MODULE, 8, { 126, SYS_GPB_MFPH_PB8MFP_EADC0_CH8 }}, //A2 PB8
    {EADC, EADC_MODULE, 9, { 125, SYS_GPB_MFPH_PB9MFP_EADC0_CH9 }}, //A3 PB9
    {EADC, EADC_MODULE, 0, {  10, SYS_GPB_MFPL_PB0MFP_EADC0_CH0 }}, //A4 PB0
    {EADC, EADC_MODULE, 1, {   9, SYS_GPB_MFPL_PB1MFP_EADC0_CH1 }}, //A5 PB1
};
