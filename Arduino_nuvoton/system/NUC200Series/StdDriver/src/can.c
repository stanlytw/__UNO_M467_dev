 ...
 * $Revision: 8 $
 * $Date: 14/05/28 7:24p $
 * @brief    NUC200 series ADC driver source file
 *
 * @note
...
/** @addtogroup NUC200_CAN_Driver CAN Driver
  @{
*/

/** @addtogroup NUC200_CAN_EXPORTED_FUNCTIONS CAN Exported Functions
  @{
*/
...
/**
  ...
  *                       CAN_TEST_TX0_Msk/CAN_TEST_TX1_Msk: Control CAN_TX pin bit feild
  * @return None
...
/*@}*/ /* end of group NUC200_CAN_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NUC200_CAN_Driver */
