 ...
 * $Revision: 6 $
 * $Date: 2/19/16 2:33p $
 * @brief    NUC131 Series CAN Driver Header File
 *
 * @note
...
/** @addtogroup NUC131_CAN_EXPORTED_CONSTANTS CAN Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------------------------------------*/
/* Message Frame ID Mask Constant Definitions                                                                 */
/*---------------------------------------------------------------------------------------------------------*/
#define    CAN_ID_MASK_ALLPASS    0
...
/*@}*/ /* end of group NUC131_CAN_EXPORTED_CONSTANTS */
